-- Complete Signup Fix - All-in-One Migration
-- Includes: Profile completion function + BEFORE trigger + Auto-create profile
-- Apply this single migration to fix all signup issues

-- ============================================
-- PART 1: Profile Completion Function
-- ============================================
...
-- ============================================
-- PART 2: BEFORE Trigger (Prevents Recursion)
-- ============================================

-- Drop old AFTER trigger if exists
DROP TRIGGER IF EXISTS trigger_update_profile_completion ON profiles;

-- Create function for BEFORE trigger
...
BEGIN
  ...
  -- Modify NEW record directly (no UPDATE - prevents recursion)
...
-- ============================================
-- PART 4: Language Skills Trigger
-- ============================================
...
-- ============================================
-- PART 5: Identity Verification Trigger
-- ============================================
...
DO $$
BEGIN
  RAISE NOTICE '✅ Complete signup fix applied successfully';
  RAISE NOTICE '✅ Profile completion function created';
  RAISE NOTICE '✅ BEFORE trigger installed (no recursion)';
  RAISE NOTICE '✅ Auto-create profile trigger installed';
